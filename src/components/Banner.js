  ...
  return (
    <div className="bannerContain">
      ...
      <div className="bannerContain__view">
        ...
        <img src={props.imgpathDesktop} className="bannerContain__view--picture bannerContain__view--pictureDesktop" alt="banner" />

        <img src={props.imgpathMobile} className="bannerContain__view--picture bannerContain__view--pictureMobile" alt="banner" />
